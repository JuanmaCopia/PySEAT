...
def insert_test2():
    ...
    Self:
                     ...
                     None <- node1: 4294967292
                     /                       \
        node1 <- node0: 4294967291            None
        /                        \            
        None                          None            
    ...
    End Self:
                      ...
                      None <- node2: 4294967291              
                     /                         \             
        node2 <- node0: 4294967291 node2 <- node1: 4294967292
        /                        \ /                        \
        None                          None None                          None

    '''
    # Self Generation
    node1 = Node(None, 4294967292)
    node1.data = 4294967292
    node1.right = None
    node1.parent = None
    node1.height = 1
    node0 = Node(node1, 4294967291)
    node0.data = 4294967291
    node0.right = None
    node0.left = None
    node0.height = 0
    node0.parent = node1
    ...
    assert avl0.repok()
    # Method call
    avl0.insert(4294967291)
    # Assertions
    # Repok check
    assert avl0.repok()
    assert avl0.root.data == 4294967291
    assert avl0.root.parent is None
    assert avl0.root.height == 1
    assert avl0.root.right.data == 4294967292
    assert avl0.root.right.right is None
    assert avl0.root.right.left is None
    assert avl0.root.right.height == 0
    assert avl0.root.left.data == 4294967291
...
def insert_test4():
    ...
    End Self:
                      ...
                      None <- node0: 4294967296              
                     /                         \             
        node0 <- node1: 4294967296 node0 <- node2: 4294967296
        /                        \ /                        \
        None                          None                           
    ...
    node1.parent = None
    node1.height = 1
    node0 = Node(node1, 4294967296)
    node0.data = 4294967296
    node0.right = None
    node0.left = None
    node0.height = 0
    node0.parent = node1
    ...
    assert avl0.repok()
    # Method call
    avl0.insert(4294967296)
    # Assertions
    # Repok check
    assert avl0.repok()
    assert avl0.root.data == 4294967296
    assert avl0.root.parent is None
    assert avl0.root.height == 1
    ...
    assert avl0.root.right.left is None
    assert avl0.root.right.height == 0
    assert avl0.root.left.data == 4294967296
    assert avl0.root.left.right is None
    assert avl0.root.left.left is None
    assert avl0.root.left.height == 0
    print('Test4: OK')
